...
from .factories import SignUpRequest
...
class TestSignUpView:
    ...
    @pytest.mark.parametrize(
        'password', ['123456', 'qqq2', '123456qwerty'], ids=['only numbers', 'too short', 'too common']
    )
    ...
    def test_passwords_missmatch(self, client, faker):
        ...
        assert response.status_code == status.HTTP_400_BAD_REQUEST
        assert response.json() == {'non_field_errors': ['Пароль не совпадает.']}
